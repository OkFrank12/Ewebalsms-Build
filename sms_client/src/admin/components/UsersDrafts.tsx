...
import { useviewAllDraftsAPI } from "../../hooks/customHooks";
import { FaEye } from "react-icons/fa";

const UsersDrafts = () => {
  const { data, isLoading } = useviewAllDraftsAPI();
  let copy = data?.slice();
  copy = copy?.reverse();
                  ...
                  copy?.map((el: any, idx: number) => (
                    <Tbody key={idx}>
                      <tr>
                        ...
                        >
                          <Link
                            to={`/admin-dashboard/manage-all-drafts/more-about-drafts/${el?._id}`}
                            onClick={() =>
