...
const MoreDraftedSMS = () => {
  const data = JSON.parse(localStorage.getItem("ewebal_drafts_more")!);

  return (
    <>
      <Body>
        <Title>Drafted SMS Details</Title>
        <BtnAbs to={`/admin-dashboard/manage-all-drafts/`}>
          <AiOutlineClose />
        </BtnAbs>
        <Holder>
          <Div>
