...
const AllMoreDetailedTransactions = () => {
  ...
  return (
    <>
      {load && <Loader />}
      {toggle && <CreditUserPop user={data} setToggle={setToggle} />}
      <Body>
        <Title>{isLoading ? "?" : data?.userName} Transaction</Title>
        <BtnAbs to={`/admin-dashboard/manage-all-transactions/`}>
          <AiOutlineClose />
        </BtnAbs>
        <Holder>
          <Left>
                          ...
                          declinedUserTransactionAPI(
                            ...
                            if (res?.status === 200) {
                              ...
                              Swal.fire({
                                ...
                                navigate(
                                  `/admin-dashboard/manage-all-transactions/`
                                );
                              });
                            } else if (res?.message) {
                              Swal.fire({
...
export default AllMoreDetailedTransactions;
