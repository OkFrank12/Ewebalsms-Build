...
import { onAdminState } from "../../storeConfig/reduxState";
import { jwtDecode } from "jwt-decode";
import { adminLoginAPI, verifyAdminAPI } from "../../api/AdminAPI";
  ...
  return (
    <>
      ...
      <InputHolder>
        <Type>
          Password{" "}
          {/* <Link style={{ textDecoration: "none" }} to={`/admin-reset-password`}>
