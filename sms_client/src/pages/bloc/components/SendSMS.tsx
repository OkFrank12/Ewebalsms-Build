...
const SendSMS = () => {
  ...
  function createPages(text: string) {
      ...
      <Block>
        ...
        <InputBloc>
          ...
          <Num gre="green" re="red">
            ...
            <p style={{ color: "red" }}>
              Pages: <span style={{ color: "red" }}>{pages.length}</span>
            </p>
          </Num>
        </InputBloc>
        <InputBloc>
        ...
        <InputBloc>
          <Span>
            SMS to* <span>Note: After each Phone Number, Place a comma.</span>{" "}
            <span>
              Each phone number must start with <b>{code}</b>
              {code === "234" ? <b> or 0</b> : ""}
            </span>
          </Span>
          <Input
